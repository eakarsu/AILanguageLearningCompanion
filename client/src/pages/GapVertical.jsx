...
// Vertical
// Vertical vocabulary packs (medical/legal/business) with domain glossaries
...
export default function GapVertical() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vertical vocabulary packs (medical/legal/business) with domain glossaries</p>
