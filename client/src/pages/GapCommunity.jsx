...
// Community
// Community forum / peer practice rooms

export default function GapCommunity() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-community', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Community</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Community forum / peer practice rooms</p>
