...
// Agentic
// Agentic conversation partner with topic steering and difficulty escalation
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic conversation partner with topic steering and difficulty escalation</p>
