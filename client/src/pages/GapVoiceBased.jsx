...
// Voice Based
// Voice-based tutor with real-time pronunciation feedback (ASR + streaming)
...
export default function GapVoiceBased() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Voice-based tutor with real-time pronunciation feedback (ASR + streaming)</p>
