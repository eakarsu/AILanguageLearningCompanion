...
// Feature: Teacher
// Description: Teacher dashboard (assign custom lessons, monitor cohorts)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Teacher. Teacher dashboard (assign custom lessons, monitor cohorts)' },
