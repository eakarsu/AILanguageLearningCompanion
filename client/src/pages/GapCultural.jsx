...
// Cultural
// Cultural immersion storytelling with mid-narrative quizzes

export default function GapCultural() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-cultural', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Cultural</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Cultural immersion storytelling with mid-narrative quizzes</p>
