...
// Feature: Limited
// Description: Limited frontend (only 6 pages vs. 17 backend domains)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Limited. Limited frontend (only 6 pages vs. 17 backend domains)' },
