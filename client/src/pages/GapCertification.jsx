...
export default function GapCertification() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-certification', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Certification</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Certification exam prep (TOEFL, IELTS)</p>
